    ...
    ui(new Ui::RegistrForm)
{
    ...
    this->setWindowTitle(QString::fromUtf8("Регистрация участника"));
}
...
void RegistrForm::on_pushButtonClose_clicked()
{
    this->close();
}

void RegistrForm::on_pushButtonGet_clicked()
{
//    ui->tabWidget->tabBar()->hide();
...
void RegistrForm::on_pushButtonBack_clicked()
{
    ui->tabWidget->setCurrentIndex(0);
    ui->tabWidget->tabBar()->hide();
}

void RegistrForm::on_pushButton2Close_clicked()
{
    this->close();
}

void RegistrForm::on_pushButton2get_clicked()
{
    PrivateData data;
...
void RegistrForm::on_pBgetPhoto_clicked()
{
